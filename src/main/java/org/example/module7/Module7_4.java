...
public class Module7_4 implements IModule {
    @Override
    ...
    public void labyrinth() {
        Scanner scanner = new Scanner(Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("input_7_4.txt")));
//        Scanner scanner = new Scanner(System.in);
        ...
        doGraph(nodes, n, m);
        String result = doPath(start, finish, door, false);
        if (null != result) {
        ...
        String sk = doPath(start, key, door, false);
        String kf = doPath(key, finish, door, true);
        if (null == sk || null == kf) {
    ...
    private String doPath(Node start, Node finish, Node door, boolean gotKey) {
